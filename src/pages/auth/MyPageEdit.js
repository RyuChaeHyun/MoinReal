...
const MyPageEdit = ({navigation}) =>{
    ...
    const onSubmitting = () =>{
        console.log('submitting: ',username, village);
        navigation.push('MyPage');
    }

    return(
        <FormScrollView buttonTitle={"수정하기"} buttonType={"Round"} onPress={()=>onSubmitting()} >
            <Styled.imageUrlBox>
                <Styled.imageUrl source={userData.profileUrl} />
            </Styled.imageUrlBox>
                <Input title={'닉네임'} defaultValue={userData.username} onChangeSetText={text=>setUsername(text)}/>
                <Input title={'동네'} defaultValue={userData.village} onChangeSetText={text=>setVillage(text)} />
        </FormScrollView>
    )
}
